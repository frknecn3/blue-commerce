...
const CATEGORIES_DATA: CategorySeed[] = [
  {
    ...
    imageUrl: "https://res.cloudinary.com/dgb1bomm8/image/upload/v1787066485/blue-commerce/categories/phones.jpg",
  },
  {
    name: "Laptops",
    nameSlug: "laptops",
    description: "Ultrabooks, creator laptops, and high-performance mobile workstations.",
    imageUrl: "https://res.cloudinary.com/dgb1bomm8/image/upload/v1787066479/blue-commerce/categories/laptops.jpg",
  },
  {
    name: "Gaming",
    nameSlug: "gaming",
    description: "Next-gen consoles, mechanical keyboards, gaming rigs, and accessories.",
    imageUrl: "https://res.cloudinary.com/dgb1bomm8/image/upload/v1787066470/blue-commerce/categories/gaming.jpg",
  },
  {
    name: "Smartwatches",
    nameSlug: "smartwatches",
    description: "Fitness trackers, cellular smartwatches, and luxury wearables.",
    imageUrl: "https://res.cloudinary.com/dgb1bomm8/image/upload/v1787066487/blue-commerce/categories/smartwatch.jpg",
  },
  {
    name: "Audio",
    nameSlug: "audio",
    description: "Noise-cancelling headphones, wireless earbuds, and studio monitors.",
    imageUrl: "https://res.cloudinary.com/dgb1bomm8/image/upload/v1787066474/blue-commerce/categories/headphones.jpg",
  },
  {
    name: "Fashion",
    nameSlug: "fashion",
    description: "Designer apparel, streetwear, sneakers, and modern accessories.",
    imageUrl: "https://res.cloudinary.com/dgb1bomm8/image/upload/v1787066461/blue-commerce/categories/fashion.jpg",
  },
  {
    name: "Furniture",
    nameSlug: "furniture",
    description: "Ergonomic office chairs, minimalist standing desks, and ambient lighting.",
    imageUrl: "https://res.cloudinary.com/dgb1bomm8/image/upload/v1787066468/blue-commerce/categories/furniture.jpg",
  },
  {
    name: "Books",
    nameSlug: "books",
    description: "Bestselling technology books, system architecture guides, and engineering literature.",
    imageUrl: "https://res.cloudinary.com/dgb1bomm8/image/upload/v1787066455/blue-commerce/categories/books.jpg",
  },
];
...
const PRODUCTS_DATA: ProductSeed[] = [
  // --- PHONES ---
  {
    ...
    price: "1199.99",
    imageUrl: "https://res.cloudinary.com/dgb1bomm8/image/upload/v1787066453/blue-commerce/products/titanium_phone.jpg",
    stock: 45,
    categorySlug: "phones",
  },
  {
  ...
  // --- LAPTOPS ---
  {
    ...
    price: "3499.00",
    imageUrl: "https://res.cloudinary.com/dgb1bomm8/image/upload/v1787066438/blue-commerce/products/macbook_laptop.jpg",
    stock: 18,
  ...
  // --- GAMING ---
  {
    ...
    price: "699.99",
    imageUrl: "https://res.cloudinary.com/dgb1bomm8/image/upload/v1787066440/blue-commerce/products/ps5_console.jpg",
    stock: 28,
    categorySlug: "gaming",
  },
  {
  ...
  // --- SMARTWATCHES ---
  {
    ...
    price: "799.00",
    imageUrl: "https://res.cloudinary.com/dgb1bomm8/image/upload/v1787066432/blue-commerce/products/apple_smartwatch.jpg",
    stock: 32,
  ...
  // --- AUDIO ---
  {
    ...
    price: "398.00",
    imageUrl: "https://res.cloudinary.com/dgb1bomm8/image/upload/v1787066442/blue-commerce/products/sony_headphones.jpg",
    stock: 60,
    categorySlug: "audio",
  },
  {
  ...
  // --- FASHION ---
  {
    ...
    price: "189.00",
    imageUrl: "https://res.cloudinary.com/dgb1bomm8/image/upload/v1787066450/blue-commerce/products/techwear_jacket.jpg",
    stock: 42,
  ...
  },
  {
    ...
    price: "599.00",
    imageUrl: "https://res.cloudinary.com/dgb1bomm8/image/upload/v1787066445/blue-commerce/products/standing_desk.jpg",
    stock: 16,
    categorySlug: "furniture",
  },
  {
  ...
  },
  {
    ...
    price: "34.50",
    imageUrl: "https://res.cloudinary.com/dgb1bomm8/image/upload/v1787066436/blue-commerce/products/clean_architecture_book.jpg",
    stock: 85,
    categorySlug: "books",
  },
  {
    ...
    price: "39.95",
    imageUrl: "https://res.cloudinary.com/dgb1bomm8/image/upload/v1787066447/blue-commerce/products/system_design_book.jpg",
    stock: 95,
    categorySlug: "books",
  },
  {
